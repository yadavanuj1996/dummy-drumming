...
class Drum extends React.Component {
  ...
  render() {
    ...
    return (
      React.createElement("div", { id: "display", class: "row h-100 w-100 justify-content-center align-items-center" },

      React.createElement(BeatDetail, { beatId: this.state.beatId }),
...
class BeatDetail extends React.Component {
  ...
  render() {
    ...
    return React.createElement("div", { id: "beat-type", class: "row justify-content-center align-items-center" }, `${result}`);
  }}
